...
"""
    ...
    Simulate 30 days with 6 different players and make the initial report.
...
def scenario_01():
    ...
    player2 = Player(wheel, "High_Risk_Martingale", PlayerType.HIGH_RISK, 0)          
    player3 = Player(wheel, "Moderate_Risk_Martingale", PlayerType.MODERATE_RISK, 10)
    player4 = Player(wheel, "Moderate_Risk_Fibonacci", PlayerType.MODERATE_RISK, 0)
    player5 = Player(wheel, "Low_Risk_Dalembert", PlayerType.LOW_RISK, 10)
    player6 = Player(wheel, "Low_Risk_Flat-Bet", PlayerType.LOW_RISK, 0)  
